      ...
      {!isFullscreen && (
        <>
          ...
          <div className="strategy mt-8 text-gray-300 p-4 bg-gray-800 rounded-lg">
            This is a war for territory. In Paper.io Unblocked 2025, your goal is to conquer as much screen space as possible. Move your block to draw lines and enclose areas to dye them your color. But be careful! When you are outside your base, your "tail" is your weak point. If an enemy hits your tail, you die.
            Winning Tactic: Don't get greedy! trying to capture huge chunks of land at once is risky because it leaves you exposed for too long. Adopt a "slow and steady" strategy, capturing small areas incrementally. Baiting enemies is also effective; pretend to be distracted, then quickly cut their line when they expose their tail. Simple yet addictive, this IO game is perfect for quick competitive sessions.
          </div>
